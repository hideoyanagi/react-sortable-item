...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indexEs6 = __webpack_require__(158);

	var _indexEs62 = _interopRequireDefault(_indexEs6);

	var _lodashNodeModernArrayFindIndex = __webpack_require__(161);

	var _lodashNodeModernArrayFindIndex2 = _interopRequireDefault(_lodashNodeModernArrayFindIndex);

	var _lodashNodeModernUtilityRange = __webpack_require__(204);

	var _lodashNodeModernUtilityRange2 = _interopRequireDefault(_lodashNodeModernUtilityRange);

	Array.prototype.move = function (from, to) {
	  this.splice(to, 0, this.splice(from, 1)[0]);
	};

	var modules = (0, _lodashNodeModernUtilityRange2['default'])(10).map(function (i) {
	  return {
	    id: i,
	    label: 'Module ' + i,
	    path: 'module.' + i,
	...
	var ExampleSortableList = _react2['default'].createClass({
	  displayName: 'ExampleSortableList',

	  handleDrop: function handleDrop(dropPath, position, event) {
	    var data = event.dataTransfer.getData('text/plain');
	    var origin = (0, _lodashNodeModernArrayFindIndex2['default'])(modules, function (module) {
	      return data === module.path;
	    });
	    var destination = (0, _lodashNodeModernArrayFindIndex2['default'])(modules, function (module) {
	...
	function update() {
	  _react2['default'].render(_react2['default'].createElement(
	    ...
	    _react2['default'].createElement(ExampleSortableList, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classSet = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFindIndex = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCallback = __webpack_require__(163),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isIterateeCall = __webpack_require__(205);
